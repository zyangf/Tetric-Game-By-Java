...
/**
 * this is class for created the L style square
 */
public class Lblocks extends TetrisShape{
    ...
    //this is the new coordinate when the L style square is turn by 90 degrees.

    int phase = -1;
    public Lblocks(){
       super( new Point[]{new Point(0,0), new Point(0,1), new Point(0,2), new Point(1,2)});

    }
    //this is the start coordinate for this L style square
    public void turn(){
