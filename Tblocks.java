...
/**
 * this is class for created the T style square
 */
public class Tblocks extends TetrisShape {
    Point [][] turnTable = {{new Point(1,-1), new Point(0, 0), new Point(-1,1), new Point(-1,-1)},
            {new Point(1,1), new Point(0,0), new Point(-1,-1), new Point(1,-1)},
            {new Point(-1,1), new Point(0,0), new Point(1,-1), new Point(1,1)},
            {new Point(-1,-1), new Point(0,0), new Point(1,1), new Point(-1,1)}
    };
    //this is the new coordinate when the T style square is turn by 90 degrees.

    int phase = -1;
    public Tblocks(){
        super(new Point[]{new Point(0,0), new Point(1,0), new Point(2,0), new Point(1,1)});
    }

    //this is the start coordinate for this T style square
    public void turn(){
