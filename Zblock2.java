...
/**
 * this is class for created the inversion Z style square
 */
public class Zblock2 extends TetrisShape {

    Point [][] turnTable = {
            {new Point(0,-2),new Point(-1,-1), new Point(0,0), new Point(-1,1)},
            {new Point(0,2), new Point(1,1), new Point(0,0), new Point(1,-1)}
    ...
    int phase = -1;
    public Zblock2(){
        super(new Point[]{new Point(0,1), new Point(1,1), new Point(1,0), new Point(2,0)});
    }
    //this is the start coordinate for this inversion Z style square
